...
$E(C_1^E)=C_0^t\ +\ P(t_{12}=1)*[C_1^t\ + P(y_1=1)C_1^p + P(y_1=0)*P(t_{13}=\emptyset)*(C_1^n+P(y_2=1)C^{FN})]\ + \\ [P(t_{12}=1)P(y_1=0)P(t_{13}=2)\ +\ P(t_{12}=2)]*[C_2^t\ +\ P(y_2=1)C_2^p\ +\ P(y_2=0)C_2^n]$
...
$E(C_e)=C_0^t\ +\ P(t_{12}=1)*(C_1^t\ + P(y_1=1)C_1^p)\ + \\ [P(t_{12}=1)P(y_1=0)\ +\ P(t_{12}=2)]*[C_2^t\ +\ P(y_2=1)C_2^p\ +\ P(y_2=0)C_2^n]$
...
![](images/472cdea1c9ffa3b9fae656864ed3620.png){fig-align="center" width="526"}
...
```{r}
delegation_cost <- CMA_cost + p_r1_gt_r1_star*(GP_cost + GP_yield*GP_post_p) +    (p_r1_gt_r1_star*(1-GP_yield) + p_r1_sm_r1_star)*
...
$E(C_2^E)\ =\ C_2^t+P(y_2=1)C_2^p+P(y_2=0)[P(t_{22}=\emptyset)(P(y_0=1)C^{FN}+C_2^n)+P(t_{22}=0)(C_0^t+P(y_0=1)C_0^p+P(y_0=0)C_0^n)]$

```{r}
expert_alone_cost <- ES_cost + ES_yield*ES_post_p + 
                    (1-ES_yield)*(p_t22_exit*(ES_post_n+CMA_yield*penalty)+ 
